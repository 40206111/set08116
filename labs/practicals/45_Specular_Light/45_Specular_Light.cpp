...
bool render() {
	...
	for (auto &e : meshes) {
		...
		glUniformMatrix4fv(eff.get_uniform_location("M"), 1, GL_FALSE, value_ptr(MVP));
		// Set N matrix uniform - remember - 3x3 matrix
		glUniformMatrix4fv(eff.get_uniform_location("N"), 1, GL_FALSE, value_ptr(m.get_transform().get_normal_matrix()));
		...
		glUniform1i(eff.get_uniform_location("shininess"), 50);
