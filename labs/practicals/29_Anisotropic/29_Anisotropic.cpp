...
bool load_content() {
  ...
  // ******************************
  texs[0] = texture("textures/check_3.png", false, false);
  texs[1] = texture("textures/check_3.png", false, true);
  texs[2] = texture("textures/check_3.png", true, false);
  texs[3] = texture("textures/check_3.png", true, true);
  // *********************************
...
void main() {
  // Create application
  app application("29_Anisotropic");
