...
bool load_content() {
  ...
  // Positions
  vector<vec3> positions{vec3(0.0f, 1.0f, 0.0f), vec3(0.0f, -1.0f, 0.0f), vec3(2.0f, -1.0f, 0.0f), vec3(2.0f, 1.0f, 0.0f), vec3(0.0f, 1.0f, 0.0f) };
  // *********************************
  // Define texture coordinates for triangle
  vector<vec2> tex_coords{vec2(0.0f, 0.0f), vec2(0.0f, -1.0f), vec2(1.0f, -1.0f), vec2(1.0f, 0.0f), vec2(0.0f, 0.0f)};
  // *********************************
  // Add to the geometry
